...
The EVM scanner core is live for Ethereum, Base, Arbitrum, and Optimism. The Solana adapter includes JSON-RPC failover, slot liveness checks, and Yellowstone Geyser account subscriptions.
